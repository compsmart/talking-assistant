  ...
  return <FloatingWindow id="workspace-settings" title="Workspace Settings" initial={{ x: 72, y: 72, width: 580, height: 640 }} minWidth={460} minHeight={420} className="settings-window" onClose={onClose}>
    <div className="settings-page">
      ...
      <section><h2>Verification and Git</h2><div className="settings-grid">
        ...
        <Field label="Commit on file close"><select value={draft.git.commitOnFileManagerClose} onChange={(event) => update('git', { commitOnFileManagerClose: event.target.value as WorkspaceSettings['git']['commitOnFileManagerClose'] })}><option value="ask">Ask</option><option value="always">Always commit</option><option value="never">Never prompt</option></select></Field>
      </div><p className="settings-note">Unchecked still requires the preview container to build, start, and answer its health endpoint.</p></section>
