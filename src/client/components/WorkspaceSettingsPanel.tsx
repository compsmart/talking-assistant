  ...
  return <FloatingWindow id="workspace-settings" title="Workspace Settings" initial={{ x: 72, y: 72, width: 580, height: 640 }} minWidth={460} minHeight={420} className="settings-window" onClose={onClose}>
    <div className="settings-page">
      ...
      <section><h2>Agent access</h2>
        <Toggle checked={draft.liveAgent.directFileEdits} onChange={(value) => update('liveAgent', { directFileEdits: value })} label="Allow Assistant fast edits" detail="When enabled, the Assistant may publish one focused existing-file edit without starting durable Work Center work." />
