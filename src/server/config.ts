...
export const config = {
  ...
  assistantModel: process.env.GEMINI_ASSISTANT_MODEL || process.env.GEMINI_CODER_MODEL || 'gemini-3.5-flash',
  maxParallelAgents: Math.min(8, Math.max(1, Number(process.env.MAX_PARALLEL_AGENTS || 3))),
  ...
  orchestrationDb: resolve('.cowork/orchestration.sqlite'),
